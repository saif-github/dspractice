...
we can also implement merge sort in bottom up manner.
we sart by sorting all subarrays of 1 element and merge results into subarrays of 2 elements.
then merge the results into sun=barrays of 4 elements.
Likewise perform successive merges until the array is comletely sorted.
*/
#include <stdio.h>
#include <time.h>
#include <stdlib.h>

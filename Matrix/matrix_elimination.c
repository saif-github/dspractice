...
/*
Solving System of Linear Equations : Gauss-Jordan Elimination Method can be used
for finding the solution of a systems of linear equations which is applied throughout the mathematics.
...
Below given is the flow-chart of Gauss-Jordan Elimination Method.
*/
